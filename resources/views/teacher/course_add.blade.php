...
<div class="admin-content-body">
  ...
  <div class="am-tabs am-margin" data-am-tabs="">
    <form class="am-form" role="form" method="POST" action="/teacher/courses/add">
      {{ csrf_field() }}
      <label for="course_name">课程名称:</label>
      <input type="text" name="course_name" id="course_name" value="">
      <br>
      <label for="limit_number">课程人数:</label>
      <input type="number" name="limit_number" id="limit_number" value="">
      <br>

      <label for="course_description">课程描述：</label>
      <input type="text" name="course_description" id="course_description" value="">
      <br>
